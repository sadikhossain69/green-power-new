        ...
        <>
            <section>
                <div className=" container mx-auto py-10">
                    <div>
                        <p className={`text-[#0000FF] text-3xl text-center font-semibold akshar-font`}>What do we do?!</p>
                    ...
                    <div className=" relative flex flex-col justify-between items-center lg:flex-row py-10 px-5 space-y-4 md:space-y-0">
                        ...
                        <p className={`text-[#0000FF]  text-center text-6xl border-b-2 border-[#52FF00] mx-4 akshar-font`}>
                    ...
                    <div>
                        <span className="flex justify-center">
                            <h1 className={`text-center text-[#0000FF] lg:text-6xl md:text-3xl text-2xl border-b-2 border-[#52FF00] inline py-2 akshar-font`}>
                        ...
                        <div className="flex md:flex-row flex-col justify-between py-10 px-6 space-y-3 md:space-y-0">
                            <div>
                                <p className={`text-[#0000FF] font-semibold border-b-2 border-[#52FF00] akshar-font inline text-2xl `}>Why Green Powered Systems?</p>
                                <ul>
                            ...
                            <div>
                                <p className={`text-[#0000FF] font-semibold border-b-2 border-[#52FF00] akshar-font inline text-2xl`}>What you get?</p>
                                <ul>
